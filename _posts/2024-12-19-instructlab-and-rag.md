...
- **Training Pipeline System**: [QLoRA](https://arxiv.org/abs/2305.14314)-based
  organised in YAML files (max 2300 words per Q&A pair)   instruct for full pipeline, Merlinite 7b for simple) to transform taxonomy   entries into diverse training examples   training options optimised for different hardware configurations
...
- **Verifiable**: Comprehensive evaluation suite ensures quality of fine-tuned
  [InstructLab](https://instructlab.ai/) scales with available resources   constraints   taxonomy   models
