## TIL: 1.58-bit LLMs match full performance at a 98.6% energy cost reduction
...
The information content = $-(P \log_2{P})$ summed over all states = $-(\frac{1}{3} \log_2(\frac{1}{3}) + \frac{1}{3} \log_2(\frac{1}{3}) + \frac{1}{3} \log_2(\frac{1}{3}))$
